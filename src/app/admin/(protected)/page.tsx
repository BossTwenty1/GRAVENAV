...
const sections = [
  ...
  ["Plots", "View, search, add, and safely correct cemetery plot records.", "/admin/plots"],
  ...
  return (
    <div className="rounded-2xl border bg-surface p-6 shadow-sm sm:p-8">
      ...
      <p className="mt-4 max-w-2xl leading-7 text-muted">
        You are signed in with an approved administrator account. Deceased-person, interment, and plot record management are available; other workflows remain reserved for later tasks.
      </p>
